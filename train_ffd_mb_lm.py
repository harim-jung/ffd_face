...
def parse_args():
    ...
    parser.add_argument('--snapshot', default='snapshot/ffd_mb_lm_19', type=str)
    parser.add_argument('--log-file', default='training/logs/ffd_mb_lm_19_210317.log', type=str)
...
if __name__ == '__main__':
    writer = SummaryWriter('training/runs/ffd_mb_lm_19')
    main()
    writer.close()