...
def parse_args():
    ...
    parser.add_argument('--snapshot', default='snapshot/ffd_resnet_vertex_lm_no_pose_norm_lr_0.73', type=str)
    parser.add_argument('--log-file', default='training/logs/ffd_resnet_vertex_lm_no_pose_norm_lr_0.73_210506.log', type=str)
    ...
    parser.add_argument('--weights', default='0.73, 0.03, 0.03, 0.03, 0.03, 0.03, 0.03, 0.03, 0.03, 0.03', type=str)
...
if __name__ == '__main__':
    writer = SummaryWriter('training/runs/ffd_resnet_vertex_lm_no_pose_norm_lr_0.73')
    main()
    writer.close()