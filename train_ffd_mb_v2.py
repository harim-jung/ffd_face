...
def parse_args():
    ...
    parser.add_argument('--snapshot', default='snapshot/ffd_mb_v2', type=str)
    parser.add_argument('--log-file', default='training/logs/ffd_mb_v2_210303.log', type=str)
    parser.add_argument('--log-mode', default='w', type=str)
    parser.add_argument('--param-classes', default=1029, type=int)
    parser.add_argument('--arch', default='mobilenet_2', type=str)
...
if __name__ == '__main__':
    writer = SummaryWriter('training/runs/ffd_mb_v2')
    main()
    writer.close()