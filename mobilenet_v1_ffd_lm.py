...
# adds ffd layer after 3dmm parameter regression
...
class MobileNet(nn.Module):
    def __init__(self, widen_factor=1.0, param_classes=648, lm_classes=136, prelu=False, input_channel=3):
        """ Constructor
        Args:
...
def mobilenet_1(param_classes=648, lm_classes=136, input_channel=3):
