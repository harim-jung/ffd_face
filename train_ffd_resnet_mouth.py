...
from losses.deform_loss_flex import DeformVDCLoss, MouthLoss
...
def parse_args():
    ...
    parser.add_argument('--snapshot', default='snapshot/ffd_resnet_mouth', type=str)
    parser.add_argument('--log-file', default='training/logs/ffd_resnet_mouth_210316.log', type=str)
    ...
    parser.add_argument('--loss', default='vdc_mouth', type=str)
...
def train(train_loader, model, criterion, optimizer, epoch):
    ...
    for i, (input, target) in enumerate(train_loader):
        ...
        lm_loss = lm_criterion(param_output, param_target)
...
if __name__ == '__main__':
    writer = SummaryWriter('training/runs/ffd_resnet_mouth')
    main()
    writer.close()