...
def parse_args():
    ...
    parser.add_argument('--snapshot', default='snapshot/ffd_resnet_no_pose_axis_angle_test', type=str)
    parser.add_argument('--log-file', default='training/logs/ffd_resnet_no_pose_axis_angle_test_210411.log', type=str)
...
if __name__ == '__main__':
    writer = SummaryWriter('training/runs/ffd_resnet_no_pose_axis_angle_test')
    main()
    writer.close()