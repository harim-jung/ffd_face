...
def parse_args():
    ...
    parser.add_argument('--snapshot', default='snapshot/ffd_resnet_lm_ratio', type=str)
    parser.add_argument('--log-file', default='training/logs/ffd_resnet_lm_ratio_210324.log', type=str)
...
if __name__ == '__main__':
    writer = SummaryWriter('training/runs/ffd_resnet_lm_ratio')
    main()
    writer.close()