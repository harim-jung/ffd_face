...
def parse_args():
    ...
    parser.add_argument('--snapshot', default='snapshot/ffd_cp_1000', type=str)
    parser.add_argument('--log-file', default='training/logs/ffd_cp_1000_210222.log', type=str)
...
if __name__ == '__main__':
    writer = SummaryWriter('training/runs/ffd_cp_1000')
    main()
    writer.close()