...
def parse_args():
    ...
    parser.add_argument('--snapshot', default='snapshot/nurbs_ffd_resnet_vertex_lm_no_pose_norm', type=str)
    parser.add_argument('--log-file', default='training/logs/nurbs_ffd_resnet_vertex_lm_no_pose_norm_210507.log', type=str)
...
if __name__ == '__main__':
    writer = SummaryWriter('training/runs/nurbs_ffd_resnet_vertex_lm_no_pose_norm')
    main()
    writer.close()