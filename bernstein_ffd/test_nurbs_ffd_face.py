...
a = 3  # a+1 is the number of contol points in the x direction
b = 6
c = 3
...
print('control points lattice=', P_lattice)

print('xyz.shape=', reference_mesh.T.shape)

sample_indices = None
dic = test_face_ffd_nurbs(reference_mesh.T, faces,  U, V, W, P_lattice, sample_indices)
...
print('the reconstructed mesh (the first 10 verticies) =', reconstructed_vertices[0:10])
print('the original mesh (10 vertices) = ', reference_mesh.T[0:10] )
