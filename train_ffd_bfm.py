...
def parse_args():
    ...
    parser.add_argument('--root', default='../Datasets/300W_LP/cropped_120_aug/')
    parser.add_argument('--snapshot', default='snapshot/ffd_full_bfm', type=str)
    parser.add_argument('--log-file', default='training/logs/ffd_full_bfm_210223.log', type=str)
...
if __name__ == '__main__':
    writer = SummaryWriter('training/runs/ffd_full_bfm')
    main()
    writer.close()