...
def parse_args():
    ...
    parser.add_argument('--snapshot', default='snapshot/ffd_resnet_vertex_lm_region_lr_decay', type=str)
    parser.add_argument('--log-file', default='training/logs/ffd_resnet_vertex_lm_region_lr_decay_210412.log', type=str)
...
def train(train_loader, model, criterion, vertex_criterion, lm_criterion, param_criterion, optimizer, lr_scheduler, epoch):
...
def main():
    ...
    # for epoch in range(args.start_epoch, args.epochs + 1):
        ...
        # train for one epoch
        train(train_loader, model, criterion, vertex_criterion, lm_criterion, param_criterion, optimizer, lr_scheduler, epoch)
...
if __name__ == '__main__':
    writer = SummaryWriter('training/runs/ffd_resnet_vertex_lm_region_lr_decay')
    main()
    writer.close()