...
def parse_args():
    ...
    parser.add_argument('--snapshot', default='snapshot/ffd_resnet_region_lm_0.46_new', type=str)
    parser.add_argument('--log-file', default='training/logs/ffd_resnet_region_lm_0.46_new_210330.log', type=str)
    ...
    parser.add_argument('--source_mesh', default='train.configs/reference_mesh_lp_new.ply', type=str)
...
def train(train_loader, model, criterion, vertex_criterion, lm_criterion, optimizer, epoch):
    ...
    for i, (input, target) in enumerate(train_loader):
        ...
        lm_losses.update(loss_group.mean(), input.size(0))
...
def validate(val_loader, model, criterion, vertex_criterion, lm_criterion, epoch, log=True):
    ...
    with torch.no_grad():
        ...
        for i, (input, target) in enumerate(val_loader):
            ...
            lm_losses.append(loss_group.mean())
...
if __name__ == '__main__':
    writer = SummaryWriter('training/runs/ffd_resnet_region_lm_0.46_new')
    main()
    writer.close()