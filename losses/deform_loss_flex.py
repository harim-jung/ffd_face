...
class VertexOutputwoZoffset(nn.Module):
    def __init__(self):
        super(VertexOutputwoZoffset, self).__init__()
    ...
    def deform_aap_mesh(self, pred_param, offsetg, batch):
        pose_param = pred_param[:, :7].double()
