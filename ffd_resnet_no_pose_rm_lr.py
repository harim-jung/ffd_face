...
def parse_args():
    ...
    parser.add_argument('--snapshot', default='snapshot/ffd_resnext_vertex_lm_no_pose_norm_lr', type=str)
    parser.add_argument('--log-file', default='training/logs/ffd_resnext_vertex_lm_no_pose_norm_lr_210503.log', type=str)
    ...
    parser.add_argument('--comment', default='rot mat normalized pose, no pose param loss, wo z offset, no lr adjustment', type=str)
...
if __name__ == '__main__':
    writer = SummaryWriter('training/runs/ffd_resnext_vertex_lm_no_pose_norm_lr')
    main()
    writer.close()