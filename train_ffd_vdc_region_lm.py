...
def parse_args():
    ...
    parser.add_argument('--log-file', default='training/logs/ffd_resnet_region_lm_0.46_rm_210414.log', type=str)
...
if __name__ == '__main__':
    writer = SummaryWriter('training/runs/ffd_resnet_region_lm_0.46_rm')
    main()
    writer.close()