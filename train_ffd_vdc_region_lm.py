...
from losses.deform_loss_flex import DeformVDCLoss, RegionVDCLoss, VertexOutput, MouthLoss, RegionLMLoss, VertexOutputwoPose
...
def parse_args():
    ...
    # parser.add_argument('--start-epoch', default=20, type=int)
    ...
    # parser.add_argument('--resume', default='snapshot/ffd_resnet_region_lm_0.46_rm/ffd_resnet_region_lm_0.46_rm_checkpoint_epoch_19.pth.tar', type=str, metavar='PATH')
    ...
    # parser.add_argument('--snapshot', default='snapshot/ffd_resnet_region_lm_0.46_rm', type=str)
    # parser.add_argument('--log-file', default='training/logs/ffd_resnet_region_lm_0.46_rm_2_210414.log', type=str)
    ...
    # parser.add_argument('--source_mesh', default='HELEN_HELEN_3036412907_2_0_1.ply', type=str)
    ...
    # parser.add_argument('-j', '--workers', default=8, type=int)
    # parser.add_argument('--epochs', default=50, type=int)
    # parser.add_argument('--start-epoch', default=3, type=int)
    # parser.add_argument('--batch-size', default=64, type=int) # 128 for v2
    # parser.add_argument('--val-batch-size', default=64, type=int)
    # parser.add_argument('--base-lr', '--learning-rate', default=0.001, type=float)
    # # parser.add_argument('--momentum', default=0.9, type=float, metavar='M', help='momentum')
    # # parser.add_argument('--weight-decay', '--wd', default=0.0005, type=float)
    # parser.add_argument('--print-freq', '-p', default=1000, type=int)
    # parser.add_argument('--resume', default='snapshot/ffd_resnet_region_lm_0.46_9_99_4/ffd_resnet_region_lm_0.46_9_99_4_checkpoint_epoch_2.pth.tar', type=str, metavar='PATH')
    # parser.add_argument('--devices-id', default='0', type=str)
    # parser.add_argument('--filelists-train', default='train.configs/train_aug_120x120.list.train', type=str)
    # parser.add_argument('--filelists-val', default='train.configs/train_aug_120x120.list.val', type=str)
    # parser.add_argument('--root', default='../Datasets/train_aug_120x120')
    # parser.add_argument('--snapshot', default='snapshot/ffd_resnet_region_lm_0.46_9_99_4', type=str)
    # parser.add_argument('--log-file', default='training/logs/ffd_resnet_region_lm_0.46_9_99_4_2_210417.log', type=str)
    # parser.add_argument('--log-mode', default='w', type=str)
    # parser.add_argument('--dimensions', default='9, 99, 4', type=str)
    # parser.add_argument('--param-classes', default=15000, type=int) # 1470 + 12
    # parser.add_argument('--arch', default='resnet', type=str)
    # parser.add_argument('--optimizer', default='adam', type=str)
    # parser.add_argument('--milestones', default='30, 40', type=str)
    ...
    parser.add_argument('-j', '--workers', default=8, type=int)
    parser.add_argument('--epochs', default=50, type=int)
    parser.add_argument('--start-epoch', default=33, type=int)
    parser.add_argument('--batch-size', default=64, type=int) # 128 for v2
    parser.add_argument('--val-batch-size', default=64, type=int)
    parser.add_argument('--base-lr', '--learning-rate', default=0.001, type=float)
    # parser.add_argument('--momentum', default=0.9, type=float, metavar='M', help='momentum')
    # parser.add_argument('--weight-decay', '--wd', default=0.0005, type=float)
    parser.add_argument('--print-freq', '-p', default=1000, type=int)
    parser.add_argument('--resume', default='snapshot/ffd_resnet_region_lm_0.46_10500/ffd_resnet_region_lm_0.46_10500_checkpoint_epoch_32.pth.tar', type=str, metavar='PATH')
    parser.add_argument('--devices-id', default='2', type=str)
    parser.add_argument('--filelists-train', default='train.configs/train_aug_120x120.list.train', type=str)
    parser.add_argument('--filelists-val', default='train.configs/train_aug_120x120.list.val', type=str)
    parser.add_argument('--root', default='../Datasets/train_aug_120x120')
    parser.add_argument('--snapshot', default='snapshot/ffd_resnet_region_lm_0.46_10500', type=str)
    parser.add_argument('--log-file', default='training/logs/ffd_resnet_region_lm_0.46_10500_2_210414.log', type=str)
    parser.add_argument('--log-mode', default='w', type=str)
    parser.add_argument('--dimensions', default='6, 99, 4', type=str)
    parser.add_argument('--param-classes', default=10500, type=int) # 1470 + 12
    parser.add_argument('--arch', default='resnet', type=str)
    parser.add_argument('--optimizer', default='adam', type=str)
    parser.add_argument('--milestones', default='30, 40', type=str)
    parser.add_argument('--test_initial', default='false', type=str2bool)
    ...
    # parser.add_argument('-j', '--workers', default=8, type=int)
    # parser.add_argument('--epochs', default=50, type=int)
    # parser.add_argument('--start-epoch', default=40, type=int)
    # parser.add_argument('--batch-size', default=64, type=int) # 128 for v2
    # parser.add_argument('--val-batch-size', default=64, type=int)
    # parser.add_argument('--base-lr', '--learning-rate', default=0.001, type=float)
    # # parser.add_argument('--momentum', default=0.9, type=float, metavar='M', help='momentum')
    # # parser.add_argument('--weight-decay', '--wd', default=0.0005, type=float)
    # parser.add_argument('--print-freq', '-p', default=1000, type=int)
    # parser.add_argument('--resume', default='snapshot/ffd_resnet_region_lm_0.46_5000/ffd_resnet_region_lm_0.46_5000_checkpoint_epoch_39.pth.tar', type=str, metavar='PATH')
    # parser.add_argument('--devices-id', default='1', type=str)
    # parser.add_argument('--filelists-train', default='train.configs/train_aug_120x120.list.train', type=str)
    # parser.add_argument('--filelists-val', default='train.configs/train_aug_120x120.list.val', type=str)
    # parser.add_argument('--root', default='../Datasets/train_aug_120x120')
    # parser.add_argument('--snapshot', default='snapshot/ffd_resnet_region_lm_0.46_5000', type=str)
    # parser.add_argument('--log-file', default='training/logs/ffd_resnet_region_lm_0.46_5000_2_210414.log', type=str)
    # parser.add_argument('--log-mode', default='w', type=str)
    # parser.add_argument('--dimensions', default='4, 199, 4', type=str)
    # parser.add_argument('--param-classes', default=15000, type=int) # 1470 + 12
    # parser.add_argument('--arch', default='resnet', type=str)
    # parser.add_argument('--optimizer', default='adam', type=str)
    # parser.add_argument('--milestones', default='30, 40', type=str)
    ...
    # parser.add_argument('--filelists-val', default='train.configs/train_aug_120x120.list.val', type=str)
    # parser.add_argument('--root', default='../Datasets/train_aug_120x120')
    # parser.add_argument('--snapshot', default='snapshot/ffd_resnet_region_lm_0.46_bs', type=str)
    # parser.add_argument('--log-file', default='training/logs/ffd_resnet_region_lm_0.46_bs_210414.log', type=str)
    # parser.add_argument('--log-mode', default='w', type=str)
    # parser.add_argument('--dimensions', default='6, 9, 6', type=str)
    # parser.add_argument('--param-classes', default=1470, type=int) # 1470 + 12
    # parser.add_argument('--arch', default='resnet', type=str)
    ...
    # parser.add_argument('--base-lr', '--learning-rate', default=0.005, type=float)
    # # parser.add_argument('--momentum', default=0.9, type=float, metavar='M', help='momentum')
    # # parser.add_argument('--weight-decay', '--wd', default=0.0005, type=float)
    ...
    # parser.add_argument('--filelists-val', default='train.configs/train_aug_120x120.list.val', type=str)
    # parser.add_argument('--root', default='../Datasets/train_aug_120x120')
    # parser.add_argument('--snapshot', default='snapshot/ffd_resnet_region_lm_0.46_mse_1000', type=str)
    # parser.add_argument('--log-file', default='training/logs/ffd_resnet_region_lm_0.46_mse_100_210414.log', type=str)
    # parser.add_argument('--log-mode', default='w', type=str)
    # parser.add_argument('--dimensions', default='9, 9, 9', type=str)
    # parser.add_argument('--param-classes', default=3000, type=int) # 1470 + 12
    ...
    # parser.add_argument('--epochs', default=50, type=int)
    # parser.add_argument('--start-epoch', default=1, type=int)
    # parser.add_argument('--batch-size', default=256, type=int) # 128 for v2
    ...
    # parser.add_argument('--filelists-val', default='train.configs/train_aug_120x120.list.val', type=str)
    # parser.add_argument('--root', default='../Datasets/train_aug_120x120')
    # parser.add_argument('--snapshot', default='snapshot/ffd_resnet_region_lm_0.46_mse_sgd', type=str)
    # parser.add_argument('--log-file', default='training/logs/ffd_resnet_region_lm_0.46_mse_sgd_210414.log', type=str)
    # parser.add_argument('--log-mode', default='w', type=str)
    # parser.add_argument('--dimensions', default='6, 9, 6', type=str)
    # parser.add_argument('--param-classes', default=1470, type=int) # 1470 + 12
    # # parser.add_argument('--dimensions', default='3, 6, 3', type=str)
...
def main():
    ...
    vertex_criterion = VertexOutputwoPose().cuda()
...
if __name__ == '__main__':
    writer = SummaryWriter('training/runs/ffd_resnet_region_lm_0.46_10500')
    main()
    writer.close()