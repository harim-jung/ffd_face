...
from losses.deform_loss_z_shift import DeformVDCLoss#, ChamferLoss
...
def parse_args():
    ...
    parser.add_argument('--snapshot', default='snapshot/ffd_lr_bs_z_shift', type=str)
    parser.add_argument('--log-file', default='training/logs/ffd_lr_bs_z_shift_210222.log', type=str)
...
if __name__ == '__main__':
    writer = SummaryWriter('training/runs/ffd_lr_bs_z_shift')
    main()
    writer.close()