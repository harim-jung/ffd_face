...
def parse_args():
    ...
    parser.add_argument('--snapshot', default='snapshot/ffd_mobilenet_no_pose_axis_angle_abss', type=str)
    parser.add_argument('--log-file', default='training/logs/ffd_mobilenet_no_pose_axis_angle_abss_210426.log', type=str)
...
if __name__ == '__main__':
    writer = SummaryWriter('training/runs/ffd_mobilenet_no_pose_axis_angle_abss')
    main()
    writer.close()