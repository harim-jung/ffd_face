...
from utils.ddfa import DDFADataset, ToTensorGjz, NormalizeGjz, str2bool, AverageMeter
from utils.io import mkdir
from losses.deform_loss_flex import DeformVDCLoss, RegionVDCLoss, VertexOutput, MouthLoss, RegionLMLoss, VertexOutputRMwoZoffset
...
def parse_args():
    ...
    # parser.add_argument('--snapshot', default='snapshot/nurbs_ffd_resnet_vertex_lm_no_pose_norm_lr_990', type=str)
    # parser.add_argument('--log-file', default='training/logs/nurbs_ffd_resnet_vertex_lm_no_pose_norm_lr_990_210509.log', type=str)
    # parser.add_argument('--log-mode', default='w', type=str)
    # parser.add_argument('--dimensions', default='8, 21, 4', type=str)
    # parser.add_argument('--param-classes', default=2982, type=int) # 2970+12
    ...
    # # parser.add_argument('--weights', default='0.37, 0.07, 0.07, 0.07, 0.07, 0.07, 0.07, 0.07, 0.07, 0.07', type=str)
    ...
    # parser.add_argument('--filelists-val', default='train.configs/train_aug_120x120.list.val', type=str)
    # parser.add_argument('--root', default='../Datasets/train_aug_120x120')
    # parser.add_argument('--snapshot', default='snapshot/nurbs_ffd_resnet_vertex_lm_no_pose_norm_lr_990_0.37', type=str)
    # parser.add_argument('--log-file', default='training/logs/nurbs_ffd_resnet_vertex_lm_no_pose_norm_lr_990_0.37_210509.log', type=str)
    # parser.add_argument('--log-mode', default='w', type=str)
    # parser.add_argument('--dimensions', default='8, 21, 4', type=str)
    # parser.add_argument('--param-classes', default=2982, type=int) # 2970+12
    # parser.add_argument('--arch', default='resnet', type=str)
    ...
    # parser.add_argument('--filelists-val', default='train.configs/train_aug_120x120.list.val', type=str)
    # parser.add_argument('--root', default='../Datasets/train_aug_120x120')
    # parser.add_argument('--snapshot', default='snapshot/nurbs_ffd_resnet_vertex_lm_no_pose_norm_lr_700', type=str)
    # parser.add_argument('--log-file', default='training/logs/nurbs_ffd_resnet_vertex_lm_no_pose_norm_lr_700_210508.log', type=str)
    # parser.add_argument('--log-mode', default='w', type=str)
    # parser.add_argument('--dimensions', default='6, 19, 4', type=str)
    # parser.add_argument('--param-classes', default=2112, type=int) # 2000+12
    # parser.add_argument('--arch', default='resnet', type=str)
    # parser.add_argument('--optimizer', default='adamw', type=str)
    # # parser.add_argument('--milestones', default='30, 40', type=str)
    # # parser.add_argument('--warmup', default=5, type=int)
    ...
    # parser.add_argument('--filelists-val', default='train.configs/train_aug_120x120.list.val', type=str)
    # parser.add_argument('--root', default='../Datasets/train_aug_120x120')
    # parser.add_argument('--snapshot', default='snapshot/nurbs_ffd_resnet_vertex_lm_no_pose_norm_lr', type=str)
    # parser.add_argument('--log-file', default='training/logs/nurbs_ffd_resnet_vertex_lm_no_pose_norm_lr_210507.log', type=str)
    # parser.add_argument('--log-mode', default='w', type=str)
    # parser.add_argument('--dimensions', default='6, 6, 6', type=str)
    # parser.add_argument('--param-classes', default=1041, type=int) # 1029+12
    # parser.add_argument('--arch', default='resnet', type=str)
    # parser.add_argument('--optimizer', default='adamw', type=str)
    # # parser.add_argument('--milestones', default='30, 40', type=str)
    # # parser.add_argument('--warmup', default=5, type=int)
    ...
    # parser.add_argument('--source_mesh', default='HELEN_HELEN_3036412907_2_0_1_wo_pose.ply', type=str)
    # parser.add_argument('--loss', default='vdc_lm_mse', type=str)
    # parser.add_argument('--comment', default='rot mat normalized pose, no pose param loss, wo z offset, no lr warmup, nurbs ffd', type=str)
    # # parser.add_argument('--weights', default='0.37, 0.07, 0.07, 0.07, 0.07, 0.07, 0.07, 0.07, 0.07, 0.07', type=str)
    # parser.add_argument('--weights', default='0.46, 0.06, 0.06, 0.06, 0.06, 0.06, 0.06, 0.06, 0.06, 0.06', type=str)
...
def train(train_loader, model, criterion, vertex_criterion, lm_criterion, optimizer, epoch):
    ...
    for i, (input, target) in enumerate(train_loader):
        ...
        # p_ = pose_output.view(batch, 3, -1)
        # p = p_[:, :, :3]
        # offset = p_[:, :, -1].view(batch, 3, 1)
        # rot_vals.update(p.mean().item(), input.size(0))
        # offset_vals.update(torch.abs(offset).mean().item(), input.size(0))
...
def validate(val_loader, model, criterion, vertex_criterion, lm_criterion,  epoch, log=True):
    ...
    with torch.no_grad():
        ...
        for i, (input, target) in enumerate(val_loader):
            ...
            # p = p_[:, :, :3]
            # offset = p_[:, :, -1].view(batch, 3, 1)
            # rot_vals.append(p.mean().item())
            # offset_vals.append(torch.abs(offset).mean().item())
...
def main():
    ...
    vertex_criterion = VertexOutputRMwoZoffset(nurbs=True).cuda()
