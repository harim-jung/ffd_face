...
def parse_args():
    ...
    parser.add_argument('--snapshot', default='snapshot/phase1_wpdc_lm', type=str)
    parser.add_argument('--log-file', default='training/logs/wpdc_lm_209201.log', type=str)
...
if __name__ == '__main__':
    writer = SummaryWriter('training/runs/wpdc_lm')
    main()
    writer.close()