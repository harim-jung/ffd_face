...
def parse_args():
    ...
    parser.add_argument('--snapshot', default='snapshot/ffd_resnet_vertex_lm_no_pose_norm_lr_0.37', type=str)
    parser.add_argument('--log-file', default='training/logs/ffd_resnet_vertex_lm_no_pose_norm_lr_0.37_210506.log', type=str)
    parser.add_argument('--log-mode', default='w', type=str)
    parser.add_argument('--dimensions', default='6, 19, 4', type=str)
    parser.add_argument('--param-classes', default=2112, type=int) # 10500 + 12
    ...
    parser.add_argument('--comment', default='rot mat normalized pose, no pose param loss, wo z offset, no lr warmup', type=str)
...
def main():
    ...
    vertex_criterion = VertexOutputRMwoZoffset().cuda()
...
if __name__ == '__main__':
    writer = SummaryWriter('training/runs/ffd_resnet_vertex_lm_no_pose_norm_lr_0.37')
    main()
    writer.close()