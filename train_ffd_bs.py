...
def parse_args():
    ...
    parser.add_argument('--start-epoch', default=51, type=int)
    ...
    parser.add_argument('--resume', default='snapshot/ffd_lr_bs/ffd_lr_bs_checkpoint_epoch_50.pth.tar', type=str, metavar='PATH')
    ...
    parser.add_argument('--snapshot', default='snapshot/ffd_lr_bs_sgd', type=str)
    parser.add_argument('--log-file', default='training/logs/ffd_lr_bs_phase_2_sgd_210303.log', type=str)
...
if __name__ == '__main__':
    writer = SummaryWriter('training/runs/ffd_lr_bs_sgd')
    main()
    writer.close()