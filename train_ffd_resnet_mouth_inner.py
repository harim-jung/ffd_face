...
def parse_args():
    ...
    parser.add_argument('--snapshot', default='snapshot/ffd_resnet_mouth_inner_30', type=str)
    parser.add_argument('--log-file', default='training/logs/ffd_resnet_mouth_inner_30_210326.log', type=str)
...
def train(train_loader, model, criterion, vertex_criterion, mouth_criterion, optimizer, epoch):
    ...
    for i, (input, target) in enumerate(train_loader):
        ...
        mouth_loss = mouth_criterion(deformed_vert, target_vert, whole=False)
        ...
        loss = vertex_loss + 30 * mouth_loss
...
if __name__ == '__main__':
    writer = SummaryWriter('training/runs/ffd_resnet_mouth_inner_30')
    main()
    writer.close()