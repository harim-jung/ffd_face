...
def parse_args():
    ...
    parser.add_argument('--start-epoch', default=4, type=int)
    ...
    parser.add_argument('--snapshot', default='snapshot/ffd_resnet_region', type=str)
    parser.add_argument('--log-file', default='training/logs/ffd_resnet_region_210319.log', type=str)
...
if __name__ == '__main__':
    writer = SummaryWriter('training/runs/ffd_resnet_region')
    main()
    writer.close()